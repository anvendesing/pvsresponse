...
import { MoUnifiedWorkspace } from "@/components/manufacturing/cards/MoUnifiedWorkspace";
...
/** Default manufacturing UI — one scrollable page per MO. */
export const ManufacturingSimple = () => {
        ...
        right={
          <>
            <Button
              ...
              onClick={() => navigate("/manufacturing/cards")}
            >
              Tabbed view
            </Button>
            <Button
