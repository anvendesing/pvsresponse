...
export function oilLineMachine(line) {
    const roleLabel = line.role === "extract"
        ? "cold press"
        : line.role === "filter"
            ? "filter unit"
            : "variant filler";
...
export const OIL_EXTRACTION_LINE_MACHINES = OIL_EXTRACTION_LINES.map(oilLineMachine);
/** Long-term raw / cold storage warehouses (created by script). */
export const STORAGE_WAREHOUSES = [
    { code: "WH-STO-OILSEEDS", name: "Oil Seeds Warehouse", kind: "storage" },
    { code: "WH-STO-MILLETS", name: "Millets Warehouse", kind: "storage" },
    { code: "WH-STO-GROUNDNUT", name: "Groundnut Seeds Warehouse", kind: "storage" },
    { code: "WH-STO-FILTERMAT", name: "Filter Material Warehouse", kind: "storage" },
    { code: "WH-STO-COLD-1", name: "Cold Storage 1", kind: "storage" },
    { code: "WH-STO-COLD-2", name: "Cold Storage 2", kind: "storage" },
];
/** Expand "Destone Machine" ×3 → MCH-MILL-DSTONE-01 … with numbered names. */
export function expandMachines(codePrefix, baseName, count, description) {
...
export const MILLING_LINE_MACHINES = [
...
export const FLOUR_MILL_LINE_MACHINES = [
...
export const PRODUCTION_FACILITIES = [
    {
        ...
        description: "Production WH holds WIP and temporary FG. On complete, putaway TO moves FG to existing finished-goods warehouse. Replenish facility from storage warehouses on MO release.",
    },
    {
        ...
        description: "Facility WH is temporary FG buffer; putaway rules → finished-goods warehouse.",
    },
    {
        ...
        description: "Vacuum and manual retail packing in Stock Room zone A. Bulk flour arrives via TO from Flour Mill; grains/millets packed in situ. FG stays in STR.",
    },
    {
        facilityCode: "WC-OIL",
        ...
        description: "Six extraction lines, three filtering lines, one filling line (demand-driven variants). " +
    ...
    },
    {
        ...
        description: "Destone, hulling, rice and ragi lines; semi-FG on facility WH; replenish raw from Big Godown.",
    },
    {
        ...
        description: "Manual cleaning & grading of milled semi-FG; bulk output transferred to Stock Room for retail pack.",
    },
    {
        ...
        description: "Flour, spice and ravva grinding only; bulk FG transferred to Stock Room for retail packing.",
    },
];
/**
 ...
 */
export const PRODUCTION_LINES = PRODUCTION_FACILITIES.map((f) => ({
